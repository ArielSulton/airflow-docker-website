...
fetch_data = BashOperator(
    ...
    bash_command='curl -o /tmp/launches.json https://ll.thespacedevs.com/2.3.0/launches/?format=json',
    dag=dag
)
...
def extract_images():
    with open('/tmp/launches.json') as f:
        ...
        print(launches)
        image_urls = [launch['image']['image_url'] for launch in launches['results']]
